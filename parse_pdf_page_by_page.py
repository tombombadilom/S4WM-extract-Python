...
def parse_questions_and_answers(questions_text, answers_json):
		...
		questions_matches = question_pattern.findall(questions_text)
...
def parse_questions(text):
		...
		for match in matches:
				...
				# Get the choice letters as a list to check sequence validity
...
def main():
		...
		try:
				...
				questions_with_answers = parse_questions_and_answers(questions_text, data)

				# Save questions with matched answers to a JSON file
